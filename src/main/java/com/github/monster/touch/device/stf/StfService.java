...
import com.github.monster.touch.concurrent.NamedThreadFactory;
    ...
    protected void doStart(String cmd, BaseServiceReceiver receiver)
        ...
        threadPool.execute(() -> {
            try {
                ...
                log.info("{} stopped .", receiver.getServiceName());
            } catch (Exception e) {
                log.error("Failed to start {} service. {}", receiver.getServiceName(), e);
            }
        });
